class OrdenRequestsController < ApplicationController
  ...
  private
    ...
    def orden_request_params
      params.require(:orden_request).permit(:date_orden, :request_number, :personal_in_charge_id, :event, :price_by_ticket, :total_amount, :event_id, :event_date, :ticket_quantity,
