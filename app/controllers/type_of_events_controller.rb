  ...
  def create
    ...
    respond_to do |format|
      if @type_of_event.save
        format.html { redirect_to @type_of_event, notice: 'Type of event was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @type_of_event.update(type_of_event_params)
        format.html { redirect_to @type_of_event, notice: 'Type of event was successfully updated.' }
