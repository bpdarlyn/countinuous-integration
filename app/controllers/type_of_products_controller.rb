class TypeOfProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @type_of_product.save
        ...
        format.json { render :show, status: :created, location: @type_of_product }
      else
  ...
  def update
    respond_to do |format|
      if @type_of_product.update(type_of_product_params)
        ...
        format.json { render :show, status: :ok, location: @type_of_product }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to type_of_products_url, notice: 'Type of product was successfully destroyed.' }
  ...
  private
    ...
    def type_of_product_params
      params.require(:type_of_product).permit(:name)
    end
end
