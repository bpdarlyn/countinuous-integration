class TicketBox < ApplicationRecord
  ...
  def start_number_available
    start_number = self.start_number
    not_availables = historical_box_active.not_available
    start_number_available_quantity = start_number + not_availables
    start_number_available_quantity
  end
